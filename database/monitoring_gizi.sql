...
-- ----------------------------
-- Table structure for berat
-- ----------------------------
DROP TABLE IF EXISTS `berat`;
CREATE TABLE `berat`  (
  `id_berat` int(11) NOT NULL AUTO_INCREMENT,
  `kategori_berat` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `keterangan_berat` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
-- Records of berat
-- ----------------------------
INSERT INTO `berat` VALUES (1, 'Faseeee', '2 - 5');
...
-- Records of balita
-- ----------------------------
INSERT INTO `balita` VALUES (1, 'asd', 1, 3, 1, 122, 32);
INSERT INTO `balita` VALUES (2, 'udin', 1, 4, 2, 56.4, 33);
INSERT INTO `balita` VALUES (4, 'asd', 2, 3, 23, 55.7, 33.1);
INSERT INTO `balita` VALUES (5, 'usep', 1, 5, 12, 60, 15);
...
-- Records of hasil
-- ----------------------------
INSERT INTO `hasil` VALUES (1, 2, 'Berat Badan Berlebih', 'Normal', 'Berisiko Gizi Lebih');
INSERT INTO `hasil` VALUES (4, 4, 'Berat Badan Berlebih', 'Sangat Pendek', 'Berisiko Gizi Lebih');
INSERT INTO `hasil` VALUES (5, 5, 'Berat Badan Berlebih', 'Sangat Pendek', 'Berisiko Gizi Lebih');
...
CREATE TABLE `tinggi`  (
  `id_tinggi` int(11) NOT NULL AUTO_INCREMENT,
  `kategori_tinggi` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `keterangan_tinggi` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id_tinggi`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tinggi
-- ----------------------------
INSERT INTO `tinggi` VALUES (1, 'Faseeee', 'blok');
...
CREATE TABLE `umur`  (
  `id_umur` int(11) NOT NULL AUTO_INCREMENT,
  `kategori_umur` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `keterangan_umur` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL,
  `umur_dari` float NULL DEFAULT NULL,
  `umur_sampai` float NULL DEFAULT NULL,
  PRIMARY KEY (`id_umur`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of umur
-- ----------------------------
INSERT INTO `umur` VALUES (1, 'Umur Fase 1', 'Umur 1 - 3 Bulan', 0.2, 9.8);
INSERT INTO `umur` VALUES (2, 'Umur Fase 2', '4 - 6 Bulan', NULL, NULL);
INSERT INTO `umur` VALUES (3, 'Umur Fase 3', 'ad', NULL, NULL);
