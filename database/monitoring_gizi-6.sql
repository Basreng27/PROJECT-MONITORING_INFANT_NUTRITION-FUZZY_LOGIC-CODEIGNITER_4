...
CREATE TABLE `balita`  (
  ...
  `id_jk_balita` int NULL DEFAULT NULL,
  `id_ortu` int NULL DEFAULT NULL,
  `id_ortu_ibu` int NULL DEFAULT NULL,
  `nik` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `anak_ke` int NULL DEFAULT NULL,
  `bb_lahir` float NULL DEFAULT NULL,
  `lingkar_lengan` float NULL DEFAULT NULL,
  `lingkar_kepala` float NULL DEFAULT NULL,
  `dari_keluarga` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id_balita`) USING BTREE,
  INDEX `id_ortu`(`id_ortu` ASC) USING BTREE,
  INDEX `id_jk_balita`(`id_jk_balita` ASC) USING BTREE,
  INDEX `id_ortu_ibu`(`id_ortu_ibu` ASC) USING BTREE,
  ...
  CONSTRAINT `balita_ibfk_3` FOREIGN KEY (`id_ortu_ibu`) REFERENCES `ortu` (`id_ortu`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of balita
-- ----------------------------
INSERT INTO `balita` VALUES (10, 'Numquam adipisci est', 2, 17, 18, 'Numquam ea expedita ', 38, 41, 2, 78, 'TIDAK MAMPU');
...
CREATE TABLE `bb_pb`  (
  `id_bb_pb` int NOT NULL AUTO_INCREMENT,
  ...
  `id_jk_bb_pb` int NULL DEFAULT NULL,
  `kategori_bb_pb` int NULL DEFAULT NULL,
  PRIMARY KEY (`id_bb_pb`) USING BTREE,
  INDEX `id_jk_bb_pb`(`id_jk_bb_pb` ASC) USING BTREE,
...
CREATE TABLE `bb_u`  (
  `id_bb_u` int NOT NULL AUTO_INCREMENT,
  `umur_bb_u` int NULL DEFAULT NULL,
  `min_3_sd` float NULL DEFAULT NULL,
  `min_2_sd` float NULL DEFAULT NULL,
  `min_1_sd` float NULL DEFAULT NULL,
  `median` float NULL DEFAULT NULL,
  ...
  `plus_2_sd` float NULL DEFAULT NULL,
  `plus_3_sd` float NULL DEFAULT NULL,
  `id_jk_bb_u` int NULL DEFAULT NULL,
  PRIMARY KEY (`id_bb_u`) USING BTREE,
  INDEX `id_jk_bb_u`(`id_jk_bb_u` ASC) USING BTREE,
...
-- ----------------------------
-- Table structure for footer_user
-- ----------------------------
DROP TABLE IF EXISTS `footer_user`;
CREATE TABLE `footer_user`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `alamat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `no_telpon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of footer_user
-- ----------------------------
INSERT INTO `footer_user` VALUES (1, 'test1', '0891', 'test1');
...
CREATE TABLE `hasil`  (
  ...
  INDEX `id_balita`(`id_balita` ASC) USING BTREE,
  INDEX `id_data`(`id_data` ASC) USING BTREE,
...
CREATE TABLE `misi`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `misi` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of misi
-- ----------------------------
INSERT INTO `misi` VALUES (1, 'okeyy weh lah\r\n');
...
CREATE TABLE `ortu`  (
  ...
  `id_jk_ortu` int NULL DEFAULT NULL,
  ...
  INDEX `id_jk_ortu`(`id_jk_ortu` ASC) USING BTREE,
...
-- Records of ortu
-- ----------------------------
INSERT INTO `ortu` VALUES (17, 'Udin', 1, 'Bojong', '-', '0888989829898', '312321213123');
INSERT INTO `ortu` VALUES (18, 'Entin', 2, 'Bojong', '-', '0877997987', '1233332111');
...
CREATE TABLE `pb_u`  (
  `id_pb_u` int NOT NULL AUTO_INCREMENT,
  `umur_pb_u` int NULL DEFAULT NULL,
  `min_3_sd` float NULL DEFAULT NULL,
  `min_2_sd` float NULL DEFAULT NULL,
  `min_1_sd` float NULL DEFAULT NULL,
  `median` float NULL DEFAULT NULL,
  ...
  `plus_2_sd` float NULL DEFAULT NULL,
  `plus_3_sd` float NULL DEFAULT NULL,
  `id_jk_pb_u` int NULL DEFAULT NULL,
  PRIMARY KEY (`id_pb_u`) USING BTREE,
  INDEX `id_jk_pb_u`(`id_jk_pb_u` ASC) USING BTREE,
...
CREATE TABLE `visi`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `visi` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
