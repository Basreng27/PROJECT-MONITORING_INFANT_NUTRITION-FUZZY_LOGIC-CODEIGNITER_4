...
<section role="main" class="content-body">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title"> Standar Berat Badan menurut Umur (BB/U) Anak <?= ($jk == 1) ? 'Laki-Laki' : 'Perempuan' ?> Umur 0-60 Bulan</h2>
        </header>
            ...
            <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                <thead style="text-align: center;">
                    <tr>
                        ...
                        <td colspan="7"> Panjang Badan (CM)</td>
                    </tr>
                    <tr>
                        <td> -3 SD</td>
                        <td> -2 SD</td>
                ...
                <tbody>
                    <?php
                    $no = 1;
                    foreach ($data_pb_u as $data) : ?>
                        <tr>
                            <td><?= $no++; ?></td>
                            <td><?= $data['umur_pb_u']; ?></td>
                            <td><?= $data['min_3_sd']; ?></td>
                            <td><?= $data['min_2_sd']; ?></td>
                            <td><?= $data['min_1_sd']; ?></td>
                            <td><?= $data['median']; ?></td>
